    ...
    >
      ...
      <div className="container relative mx-auto max-w-5xl px-6">
        <div ref={ref} className="mx-auto max-w-2xl space-y-8 text-center">
          ...
          <h2
            className={cn(
              "font-serif text-4xl font-bold tracking-tight md:text-5xl",
              "opacity-0",
          ...
          >
            I&apos;m currently available for freelance work and remote positions with US-based
            teams. Let&apos;s discuss how I can help bring your ideas to life.
          </p>
